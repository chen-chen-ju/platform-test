...
void PerformanceMS::Measure(int link)
{
	...
	double temp1 = MS[id]->scheduling->uplinkESINR;
	if (arma::randu() > FER(temp, MS[id]->scheduling->MCS))
	{
		if (link == 0)
		{
			...
			cout << "ID: " << id << endl;
			cout << "Efficiency:  " << MS[id]->scheduling->downlinkspectralEfficiency << endl;
			cout << "SINR:  " << temp << "  MCS:  " << MS[id]->scheduling->MCS << endl;
			cout << "0: " << instantThroughput << endl;
		}
		else
		{
			...
			cout << "ID: " << id << endl;
			cout << "Efficiency:  " << MS[id]->scheduling->uplinkspectralEfficiency << endl;
			cout << "SINR:  " << temp1 << "  MCS:  " << MS[id]->scheduling->MCS << endl;
			cout << "1: " << instantThroughput << endl;
		}
	...
	else
	{
		...
		{
			instantThroughput = 0;
			MS[id]->scheduling->uplinkHARQeSINR = MS[id]->scheduling->uplinkHARQeSINR + temp1;
